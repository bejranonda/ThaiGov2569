...
export async function onRequestPost({ request, env }) {
    try {
        ...
        // 6. PM Prompt
        const pmPrompt = `คุณคือนายกรัฐมนตรีจากพรรค${pmParty.name} กำลังตอบคำถามประชาชนในห้องแถลงข่าว
...
- แสดงความมุ่งมั่นและวิสัยทัศน์ส่วนตัว`;
        ...
        // 7. Opposition Prompt
        const oppPrompt = `คุณคือผู้นำฝ่ายค้านจากพรรค${mainOpposition.name} กำลังให้ความเห็นต่อคำตอบของนายกฯ
